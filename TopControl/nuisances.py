# Empty nuisances dict created by mkShapesMulti.py, filled in here
...
cuts0j = ['ww_TopCR_btag_0j']
cuts1j = ['ww_TopCR_btag_1j']
cuts2j = ['ww_TopCR_btag_2j']

#for k in cuts:
#    if 'categories' in cuts[k]:
...
nuisances['trigg_drll_rw_unc'] = {
    'name': 'CMS_eff_hwwtrigger_drllrw',
    'kind': 'weight',
    'type': 'shape',
...
nuisances['trigg_emb'] = {
    'name': 'CMS_eff_hwwtrigger_embedded',
    'kind': 'weight',
    'type': 'shape',
